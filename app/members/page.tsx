...
import { Users, Search, Trophy, TrendingUp, Loader2, AlertCircle } from "lucide-react"
...
export default function MembersPage() {
  ...
  useEffect(() => {
    ...
    fetchMembers()
  }, [searchQuery, filterField, filterYear, filterStatus, toast])
      ...
      <DashboardPageLayout
        header={{
          ...
          description: isLoading 
            ? "Chargement..." 
            : `${membersData.length} membres • ${membersData.filter((m) => m.status === "online").length} en ligne`,
          icon: Users,
        }}
      >
        {error && (

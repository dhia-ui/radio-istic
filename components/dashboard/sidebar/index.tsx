...
export function DashboardSidebar({ className, ...props }: React.ComponentProps<typeof Sidebar>) {
  return (
    <Sidebar {...props} className={cn("py-sides", className)} suppressHydrationWarning>
      ...
      <SidebarFooter className="p-0">
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem>
                {/* Popover temporarily disabled to fix infinite loop */}
                <div className="flex gap-0.5 w-full group cursor-pointer">
                  ...
                  <div className="group/item pl-3 pr-1.5 pt-2 pb-1.5 flex-1 flex bg-sidebar-accent items-center rounded">
                    <div className="grid flex-1 text-left text-sm leading-tight">
